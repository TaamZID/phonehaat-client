        ...
        <form onSubmit={handleProduct}>
          <div className="w-full py-2 text-xl font-normal text-gray-700 bg-white bg-clip-padding">
            <div className="mb-6">
              ...
              <select id="id">
                <option value="637fb2f862bf93b0784eda69" selected>
                  Apple
                </option>
                <option value="637fb70562bf93b07853c544">Samsung</option>
                <option value="637fb77562bf93b078544299">Google Pixel</option>
              </select>
            </div>
          </div>
